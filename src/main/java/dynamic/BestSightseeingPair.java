...
public class BestSightseeingPair {
    public static void main(String[] args) {
        ...
        System.out.println(bsp.maxScoreSightseeingPair(new int[]{8, 1, 5, 2, 6}));
        System.out.println(bsp.maxScoreSightseeingPair(new int[]{1, 2}));
    }
    ...
    public int maxScoreSightseeingPair(int[] values) {
        ...
        for (int i = 1; i < values.length; i++) {
            ...
            if (values[sIndex] + sIndex < values[i] + i)    // (i < j) constraint
                sIndex = i;
        }
        return max;
    }
